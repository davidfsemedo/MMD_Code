...
def get_params(data_dir, dir, image_annoy_dir):
    ...
    param['train_data_file'] = os.path.join(dir, "dump", "train_data_file.pkl")
    param['valid_data_file'] = os.path.join(dir, "dump", "valid_data_file.pkl")
    param['test_data_file'] = os.path.join(dir, "dump", "test_data_file.pkl")
    param['vocab_file'] = os.path.join(dir, "vocab.pkl")
    param['vocab_stats_file'] = os.path.join(dir, "vocab_stats.pkl")
    param['model_path'] = os.path.join(dir, "model")
